...
; total bytes: 268796 (205.1% of 128.0k flash with -137724 free)
...
; start
    ...
    .hex D88AC77FF689AF8B ; hex template hash
...
; endfun
    ;
; Function stringSubstr core/pxt-helpers.ts:376
    ;
    .section code
    .balign 4
    .section code
helpers_stringSubstr__P206:
helpers_stringSubstr__P206_nochk:
    @stackmark func
    @stackmark args
    push {lr}
.locals:
    @stackmark locals
helpers_stringSubstr__P206_locals:
    ldr r0, [sp, args@2]
    movs r1, #0
    bl _cmp_eqq
    beq .condexprz_0_5      
