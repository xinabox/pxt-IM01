...
; Virtual methods: 0 / 0
; generated code sizes (bytes): 2920 (incl. 2058 user, 780 helpers, 14 vtables, 68 lits); src size 0
; assembly: 2088 lines; density: 60.53 bytes/stmt; (34 stmts)
; total bytes: 197480 (81.4% of 237.0k flash with 45208 free)
; peep hole pass: 47 instructions removed and 57 updated
...
; start
    ...
    .hex EAAD849F24197A24 ; hex template hash
...
; endfun
    ;
; Function appendFile cs11.ts:52
    ;
    .section code
    .balign 4
    .section code
CS11_appendFile__P596:
CS11_appendFile__P596_nochk:
    @stackmark func
    @stackmark args
    push {lr}
.locals:
    @stackmark locals
CS11_appendFile__P596_locals:
    ldr r0, [sp, args@0]
    push {r0} ; proc-arg
    bl CS11_truncateStringLength__P606
_proccall7:
    add sp, #4*1 ; pop locals 1
    str r0, [sp, args@0]
    @stackempty locals
...
.ret.596:
    ...
    movs r0, #0
.final_4_3:
CS11_appendFile__P596_end:
    pop {pc}
    @stackempty func
    @stackempty args
; endfun
    ;
; Function createFolder cs11.ts:89
    ;
    .section code
    .balign 4
    .section code
CS11_createFolder__P599:
CS11_createFolder__P599_nochk:
    @stackmark func
    @stackmark args
    push {lr}
.locals:
    @stackmark locals
CS11_createFolder__P599_locals:
    ldr r0, [sp, args@0]
    push {r0} ; proc-arg
    bl _conv_3
    mov r7, sp
...
.ret.599:
    ...
    movs r0, #0
.final_0_4:
CS11_createFolder__P599_end:
    pop {pc}
    @stackempty func
    @stackempty args
; endfun
    ;
; Function truncateStringLength cs11.ts:124
    ;
    .section code
    .balign 4
    .section code
CS11_truncateStringLength__P606:
CS11_truncateStringLength__P606_nochk:
    @stackmark func
    @stackmark args
    push {lr}
.locals:
    ...
    push {r0} ;loc
    @stackmark locals
CS11_truncateStringLength__P606_locals:
    ldr r0, [sp, args@0]
    push {r0} ; proc-arg
    bl _conv_3
    ldr r1, _ldlit_6      
...
.final_2_5:
    add sp, #4*2 ; pop locals 2
CS11_truncateStringLength__P606_end:
    pop {pc}
    @stackempty func
    @stackempty args
; endfun
...
; Function showNumber core/basic.ts:12
    ...
    .balign 4
    .section code
basic_showNumber__P338:
basic_showNumber__P338_nochk:
    @stackmark func
    @stackmark args
    push {lr}
.locals:
    @stackmark locals
basic_showNumber__P338_locals:
    movs r0, #5
    push {r0} ; proc-arg
    ldr r0, [sp, args@0]
    push {r0} ; proc-arg
    bl Math_roundWithPrecision__P203
_proccall13:
    add sp, #4*2 ; pop locals 2
    push {r0} ; proc-arg
    mov r7, sp
...
.ret.338:
    ...
    movs r0, #0
.final_0_6:
basic_showNumber__P338_end:
    pop {pc}
    @stackempty func
    @stackempty args
; endfun
    ;
; Function roundWithPrecision core/pxt-helpers.ts:550
    ;
    .section code
    .balign 4
    .section code
Math_roundWithPrecision__P203:
Math_roundWithPrecision__P203_nochk:
    @stackmark func
    @stackmark args
    push {lr}
.locals:
    ...
    push {r0} ;loc
    @stackmark locals
Math_roundWithPrecision__P203_locals:
    ldr r0, [sp, args@1]
    movs r1, #1
    bl _numops_orrs
    str r0, [sp, args@1]
...
.final_6_7:
    add sp, #4*2 ; pop locals 2
Math_roundWithPrecision__P203_end:
    pop {pc}
    @stackempty func
    @stackempty args
; endfun
